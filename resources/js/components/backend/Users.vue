                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea v-model="form.bio" name="bio" placeholder="Short Bio of User(Optional)"
                        ...
                        <div class="form-group">
                            ...
                            <select v-model="form.type" name="type" class="form-control" :class="{
    ...
    export default {
        ...
        methods:{
            ...
            editModal(user){
                ...
                this.form.clear();
                this.form.reset();
                $('#addNew').modal('show');axios.get('api/user').then(({data}) => (this.users = data.data))
                this.form.fill(user)
